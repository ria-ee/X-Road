...
## Version history
 ...
 14.09.2017 | 3.0     | Added HSM slot index configuration info | Toomas Vahtra
...
To prevent scanning a lot of unnecessary slots specific slot indexes can be configured in `/etc/xroad/conf.d/signer.ini`
